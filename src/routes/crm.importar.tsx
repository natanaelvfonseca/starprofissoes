  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Importação manual de leads para a unidade ativa. Acesso exclusivo para DEV."
      />
      <Card>
        <CardHeader>
          ...
          <Card>
            ...
            <CardContent className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Select value={attendanceId} onValueChange={setAttendanceId} disabled={!courseId}>
                  <SelectTrigger>
                ...
                {courseId && !attendances.some((attendance) => attendance.courseId === courseId) ? (
                  <p className="text-xs text-muted-foreground">
                    Nenhuma turma ativa para este curso.
                  </p>
                ) : null}
              </div>
            </CardContent>
